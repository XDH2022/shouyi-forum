  ...
  <el-container>
    ...
    <el-footer>
      ...
      <div class="footer-text">
        <span><el-icon><InfoFilled/></el-icon>首义交流平台</span>
      </div>
    </el-footer>
  </el-container>
...
import {Apple, InfoFilled, KnifeFork, Mug, Platform, Search, Star, SwitchButton, User} from '@element-plus/icons-vue'
