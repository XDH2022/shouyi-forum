...
public class OriginUserServiceImpl extends ServiceImpl<OriginUserMapper, OriginUser>
    ...
    @Override
    public List<Long> findOidListByUid(Long uid) {
        return baseMapper.findOidListByUid(uid);
    }
    @Override
    public void quitOriginUser(Long oid,Long uid) {
        originUserMapper.deleteOriginUser(oid,uid);
    }
}
