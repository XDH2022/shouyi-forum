  ...
  <div>
    <div class="container">
      <div class="handle-box">
        <el-input v-model="query.userName" placeholder="创建人" class="handle-input mr10"></el-input>
      ...
      <el-table
        ...
        <el-table-column label="操作" width="260" align="center">
          <template #default="scope">
            <el-button text type="warning" :icon="Edit" @click="handleEdit(scope.$index, scope.row)" v-permiss="30">
              编辑
            </el-button>
            <el-button text type="danger" :icon="Delete" @click="handleDelete(scope.$index,scope.row)" v-permiss="31">
              删除
            </el-button>
            <el-button text type="success" @click="goOriginUser(scope.$index, scope.row)" v-permiss="32">
              组织列表
            </el-button>
          </template>
        </el-table-column>
