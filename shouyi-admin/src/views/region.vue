      ...
      <span class="dialog-footer">
        <el-form :model="addRegionInfo" label-width="120px">
          <el-form-item  label="地区" name="label">
            <el-input v-model="addRegionInfo.label" placeholder="请输入地区名字" style="width: 280px"/>
          </el-form-item>
          <el-form-item label="地区行政编码" name="code">
            <el-input v-model="addRegionInfo.code" placeholder="请输入地区编码" style="width: 280px"/>
          </el-form-item>
    ...
    <template #footer>
      <span class="dialog-footer">
        <el-form :model="updateRegionInfo" label-width="120px">
          <el-form-item  label="地区" name="label">
            <el-input v-model="updateRegionInfo.label" placeholder="请输入地区名字" style="width: 280px"/>
          </el-form-item>
          <el-form-item label="地区行政编码" name="code">
            <el-input v-model="updateRegionInfo.code" placeholder="请输入地区编码" style="width: 280px"/>
          </el-form-item>
          <el-form-item label="父id" name="parentId">
