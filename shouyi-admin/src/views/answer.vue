      ...
      <el-table :data="commentData"
        ...
        <el-table-column label="采纳情况" align="center">
          <template #default="scope">
            ...
            <el-icon v-if="scope.row.isAdopt === 1" style="color: green" name="el-icon-check"><Select /></el-icon>
            <el-icon v-else-if="scope.row.isAdopt === 0"  name="el-icon-close" ><SemiSelect /></el-icon>
          </template>
        </el-table-column>
